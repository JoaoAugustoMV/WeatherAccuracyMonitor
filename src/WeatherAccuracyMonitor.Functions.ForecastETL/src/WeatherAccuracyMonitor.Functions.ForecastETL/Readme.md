...
WORKDIR /src
COPY ["WeatherAccuracyMonitor.Functions.ForecastETL.csproj", "WeatherAccuracyMonitor.Functions.ForecastETL/"]
RUN dotnet restore "WeatherAccuracyMonitor.Functions.ForecastETL/WeatherAccuracyMonitor.Functions.ForecastETL.csproj"

WORKDIR "/src/WeatherAccuracyMonitor.Functions.ForecastETL"
COPY . .
RUN dotnet build "WeatherAccuracyMonitor.Functions.ForecastETL.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "WeatherAccuracyMonitor.Functions.ForecastETL.csproj" \
...
Execute unit tests
```
cd "WeatherAccuracyMonitor.Functions.ForecastETL/test/WeatherAccuracyMonitor.Functions.ForecastETL.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "WeatherAccuracyMonitor.Functions.ForecastETL/src/WeatherAccuracyMonitor.Functions.ForecastETL"
